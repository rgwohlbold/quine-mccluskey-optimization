...
static inline void merge_avx2_sp_single_register_aleksa_128(__m256i impl1, __m256i primes1, __m128i *result, __m256i *primes_result) {
...
static inline void merge_avx2_sp_single_register_aleksa(int bit_difference, __m256i impl1, __m256i primes1, __m128i *result, __m256i *primes_result) {
    ...
    case 64:
        ...
        break;
    case 128:
        merge_avx2_sp_single_register_aleksa_128(impl1, primes1, result, primes_result);
        break;
    default:
        break;
    }
