...
static inline void merge_avx512_sp_block_register_old(
...
static void merge_avx512_sp_block_old(bitmap implicants, bitmap primes, size_t input_index, size_t output_index, int num_bits, int first_difference) {
    ...
    if (num_registers >= 4) {
        ...
        for (size_t regist = 0; regist < num_registers; regist += 4) {
            ...
            merge_avx512_sp_block_register_old(implicants, primes, idx1_1, &aggregated_1_1, &aggregated_2_1, &aggregated_4_1, &aggregated_8_1,
            ...
            merge_avx512_sp_block_register_old(implicants, primes, idx1_2, &aggregated_1_2, &aggregated_2_2, &aggregated_4_2, &aggregated_8_2,
            ...
            merge_avx512_sp_block_register_old(implicants, primes, idx1_3, &aggregated_1_3, &aggregated_2_3, &aggregated_4_3, &aggregated_8_3,
            ...
            merge_avx512_sp_block_register_old(implicants, primes, idx1_4, &aggregated_1_4, &aggregated_2_4, &aggregated_4_4, &aggregated_8_4,
        ...
        for (size_t regist = 0; regist < num_registers; regist++) {
            merge_avx512_sp_block_register_old(implicants, primes, idx1, &aggregated_1_1, &aggregated_2_1, &aggregated_4_1, &aggregated_8_1,
                             &aggregated_16_1, &aggregated_32_1, &aggregated_64_1, &aggregated_128_1, &aggregated_256_1,
                              indices_sr_64_lane, indices_sr_128_lane, indices_sr_256_reg,
                              indices_sr_64_reg, indices_sr_128_reg, indices_lower_and_lower, indices_sl_64_lane,
                              indices_sl_128_lane, and_mask_1, and_mask_2, and_mask_4, and_mask_8,
