...
#endif
static inline void merge_neon_sp_block(bitmap implicants, bitmap primes, size_t input_index, size_t output_index,
    ...
    for (size_t regist = 0; regist < num_registers; regist++) {
        ...
        // 64 bit
        aggregated1 = vandq_u64(vorrq_u64(aggregated1, shifted1),
                                vcombine_u64(vcreate_u64(0xFFFFFFFFFFFFFFFF), vcreate_u64(0x0)));
        aggregated2 = vandq_u64(vorrq_u64(aggregated2, shifted2),
                                vcombine_u64(vcreate_u64(0xFFFFFFFFFFFFFFFF), vcreate_u64(0x0)));
        aggregated4 = vandq_u64(vorrq_u64(aggregated4, shifted4),
                                vcombine_u64(vcreate_u64(0xFFFFFFFFFFFFFFFF), vcreate_u64(0x0)));
        aggregated8 = vandq_u64(vorrq_u64(aggregated8, shifted8),
                                vcombine_u64(vcreate_u64(0xFFFFFFFFFFFFFFFF), vcreate_u64(0x0)));
        aggregated16 = vandq_u64(vorrq_u64(aggregated16, shifted16),
                                 vcombine_u64(vcreate_u64(0xFFFFFFFFFFFFFFFF), vcreate_u64(0x0)));
        aggregated32 = vandq_u64(vorrq_u64(aggregated32, shifted32),
                                 vcombine_u64(vcreate_u64(0xFFFFFFFFFFFFFFFF), vcreate_u64(0x0)));
        aggregated64 = vandq_u64(vorrq_u64(aggregated64, shifted64),
                                 vcombine_u64(vcreate_u64(0xFFFFFFFFFFFFFFFF), vcreate_u64(0x0)));
        ...
        for (int block = 0; block < num_blocks; block += 4) {
            ...
            for (int k = 0; k < block_len; k += 128) {
                ...
                if (i + 1 >= first_difference) {
                    size_t out =
                        output_index + ((i + 1 - first_difference) << (num_bits - 1)) + (block * block_len + k);
                ...
                if (i + 2 >= first_difference) {
                    size_t out =
                        output_index + ((i + 2 - first_difference) << (num_bits - 1)) + (block * block_len + k);
