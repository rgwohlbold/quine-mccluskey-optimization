...
static inline void merge_avx2_single_register(int bit_difference, __m256i impl1, __m256i merged1, __m128i *result,
...
static inline void merge_avx2(bitmap implicants, bitmap merged, size_t input_index, size_t output_index, int num_bits,
