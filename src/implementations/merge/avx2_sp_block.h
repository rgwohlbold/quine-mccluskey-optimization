...
static inline void merge_avx2_sp_single_register_shuffle_1(__m256i impl1, __m256i primes1, __m128i *result,
    ...
    __m256i shuffle_mask = _mm256_set_epi8(-1, -1, -1, -1, -1, -1, -1, -1, 14, 12, 10, 8, 6, 4, 2, 0, -1, -1, -1, -1,
                                           -1, -1, -1, -1, 14, 12, 10, 8, 6, 4, 2, 0);
...
static inline void merge_avx2_sp_single_register_shuffle_2(__m256i impl1, __m256i primes1, __m128i *result,
                                                           __m256i *primes_result) {
...
static inline void merge_avx2_sp_single_register_shuffle_4(__m256i impl1, __m256i primes1, __m128i *result,
                                                           __m256i *primes_result) {
...
static inline void merge_avx2_sp_single_register_shuffle_8(__m256i impl1, __m256i primes1, __m128i *result,
                                                           __m256i *primes_result) {
...
static inline void merge_avx2_sp_single_register_shuffle_16(__m256i impl1, __m256i primes1, __m128i *result,
                                                            __m256i *primes_result) {
...
static inline void merge_avx2_sp_single_register_shuffle_32(__m256i impl1, __m256i primes1, __m128i *result,
                                                            __m256i *primes_result) {
...
static inline void merge_avx2_sp_single_register_shuffle_64(__m256i impl1, __m256i primes1, __m128i *result,
                                                            __m256i *primes_result) {
...
static inline void merge_avx2_sp_single_register_shuffle_128(__m256i impl1, __m256i primes1, __m128i *result,
                                                             __m256i *primes_result) {
        ...
        for (int block = 0; block < num_blocks; block += 8) {
            ...
            for (int k = 0; k < block_len_b; k += 32) {
                ...
                if (i >= first_difference) {
                    ...
                    _mm256_store_si256((__m256i *)(implicants.bits + level_base_idx + (block + 0) * block_len_b + k),
                                       res_i_01);
                    _mm256_store_si256((__m256i *)(implicants.bits + level_base_idx + (block + 1) * block_len_b + k),
                                       res_i_23);
                    _mm256_store_si256((__m256i *)(implicants.bits + level_base_idx + (block + 2) * block_len_b + k),
                                       res_i_45);
                    _mm256_store_si256((__m256i *)(implicants.bits + level_base_idx + (block + 3) * block_len_b + k),
                                       res_i_67);
                    _mm256_store_si256((__m256i *)(implicants.bits + level_base_idx + (block + 4) * block_len_b + k),
                                       res_i_89);
                    _mm256_store_si256((__m256i *)(implicants.bits + level_base_idx + (block + 5) * block_len_b + k),
                                       res_i_1011);
                    _mm256_store_si256((__m256i *)(implicants.bits + level_base_idx + (block + 6) * block_len_b + k),
                                       res_i_1213);
                    _mm256_store_si256((__m256i *)(implicants.bits + level_base_idx + (block + 7) * block_len_b + k),
                                       res_i_1415);
                }
        ...
        for (int block = 0; block < num_blocks; block += 4) {
            ...
            for (int k = 0; k < block_len_b; k += 32) {
                ...
                if (i + 1 >= first_difference) {
                    ...
                    o_idx =
                        output_index_b + ((i + 1 - first_difference) << (num_bits - 4)) + (block + 1) * block_len_b + k;
                    _mm256_store_si256((__m256i *)(implicants.bits + o_idx), res13);
                    o_idx =
                        output_index_b + ((i + 1 - first_difference) << (num_bits - 4)) + (block + 2) * block_len_b + k;
                    _mm256_store_si256((__m256i *)(implicants.bits + o_idx), res46);
                    o_idx =
                        output_index_b + ((i + 1 - first_difference) << (num_bits - 4)) + (block + 3) * block_len_b + k;
                ...
                if (i + 2 >= first_difference) {
                    ...
                    o_idx =
                        output_index_b + ((i + 2 - first_difference) << (num_bits - 4)) + (block + 1) * block_len_b + k;
                    _mm256_store_si256((__m256i *)(implicants.bits + o_idx), res15);
                    o_idx =
                        output_index_b + ((i + 2 - first_difference) << (num_bits - 4)) + (block + 2) * block_len_b + k;
                    _mm256_store_si256((__m256i *)(implicants.bits + o_idx), res26);
                    o_idx =
                        output_index_b + ((i + 2 - first_difference) << (num_bits - 4)) + (block + 3) * block_len_b + k;
